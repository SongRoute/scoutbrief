...
SECTION_SPECS = {
    ...
    "bullpen": {
        ...
        "instructions": (
            ...
            "전략의 근거는 표의 순위(threat_score 내림차순)다: 상위 순위 = 위협적, "
            "하위 순위 = 상대적으로 공략 가능. vsL xwOBA 값을 직접 해석해 '높다/낮다'로 "
            "위협을 판단하지 마라 — 그 값은 표 컬럼에 옮겨 적기만 한다.\n"
    ...
    "gameplan": {
        ...
        "instructions": (
            ...
            "- 개인 전적(BVP)의 필드는 bvp_pa와 bvp_xwoba 둘뿐이다. vsL_xwoba는 "
            "좌타 '전체' 상대 성적이지 개인 전적이 아니다 — 둘을 혼동하지 마라.\n"
            "- bvp_xwoba가 null인 투수는 개인 전적 표본이 없다는 뜻이다 — 그 투수를 "
            "개인 전적(BVP)을 근거로 서술하지 마라.\n"
            "- bvp_pa가 작은 투수의 bvp_xwoba를 근거로 강한 주장을 하지 마라 — 소표본이다.\n"
